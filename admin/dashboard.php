            ...
            <div class="panel panel-red">
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <div class="col-sm-9 text-right">
                            <div class="huge"><span>10</span></div>
    ...
    <div class="card" style="margin: 20px 10px">
        ...
        <div class="card-header tab" style="padding:0px;">
            ...
            <button class="tablinks_orders"
                onclick="openTab(event, 'completed_orders','tabcontent_orders','tablinks_orders')">Completed Orders</button>
            <button class="tablinks_orders"
                onclick="openTab(event, 'canceled_orders','tabcontent_orders','tablinks_orders')">Canceled Orders</button>
        </div>
                        ...
                        if ($count == 0) {
                            ...
                            foreach ($placed_orders as $order) {
                                ...
                                <button class="btn btn-info btn-sm rounded-0" type="button" data-toggle="modal"
                                    data-target="#<?php echo "client_" . $order['client_id']; ?>" data-placement="top">
                                    <?php echo $order['client_id']; ?>
                                </button>

                                <!-- Client Modal -->

                                <div class="modal fade" id="<?php echo "client_" . $order['client_id']; ?>" tabindex="-1"
                                            ...
                                            <div class="modal-body">
                                                <ul>
                                                    <li><span style="font-weight: bold;">Full name: </span>
                                                        <?php echo $order['client_name']; ?></li>
                                                    <li><span style="font-weight: bold;">Phone number:
                                                        </span><?php echo $order['client_phone']; ?></li>
                                                    <li><span style="font-weight: bold;">E-mail:
                                                        </span><?php echo $order['client_email']; ?></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <ul class="list-inline m-0">
                                    ...
                                    <li class="list-inline-item" data-toggle="tooltip" title="Deliver Order">
                                        <button class="btn btn-info btn-sm rounded-0" type="button" data-toggle="modal"
                                            data-target="#<?php echo $deliver_data; ?>" data-placement="top">
                                            <i class="fas fa-truck"></i>
                                        </button>

                                        <!-- DELIVER MODAL -->
                                        <div class="modal fade" id="<?php echo $deliver_data; ?>" tabindex="-1" role="dialog"
                                            aria-labelledby="<?php echo $deliver_data; ?>" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button type="button" data-id="<?php echo $order['order_id']; ?>"
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control"
                                                                id="cancellation_reason_order_<?php echo $order['order_id'] ?>"
                    ...
                    <tbody>
                        ...
                        if ($count == 0) {
                            ...
                            foreach ($rows as $row) {
                                ...
                                // Pastikan $order telah didefinisikan dan tidak null sebelum digunakan
                                if ($order !== null && isset($order['order_id'])) {
                                    ...
                                    // Lakukan sesuatu jika $order adalah null atau tidak memiliki indeks 'order_id', misalnya, tampilkan pesan kesalahan atau lakukan tindakan lain sesuai kebutuhan
                                }
                            ...
                            foreach ($reservations as $reservation) {
                                ...
                                <ul class="list-inline m-0">
                                    ...
                                    <li class="list-inline-item" data-toggle="tooltip" title="Liberate Table">
                                        <button class="btn btn-info btn-sm rounded-0" type="button" data-toggle="modal"
                                            data-target="#<?php echo $liberate_data; ?>" data-placement="top">
                                            <i class="far fa-check-circle"></i>
                                        </button>

                                        <!-- LIBERATE MODAL -->
                                        <div class="modal fade" id="<?php echo $liberate_data; ?>" tabindex="-1" role="dialog"
                                            aria-labelledby="<?php echo $liberate_data; ?>" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                    ...
                                    <li class="list-inline-item" data-toggle="tooltip" title="Cancel Reservation">
                                        <button class="btn btn-danger btn-sm rounded-0" type="button" data-toggle="modal"
                                            data-target="#<?php echo $cancel_data_reservation; ?>" data-placement="top">
                                            <i class="fas fa-calendar-times"></i>
                                        </button>

                                        <!-- CANCEL MODAL -->
                                        <div class="modal fade" id="<?php echo $cancel_data_reservation; ?>" tabindex="-1"
                                            role="dialog" aria-labelledby="<?php echo $cancel_data_reservation; ?>"
                                            aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="form-group">
                                                            <label>Cancellation Reason</label>
                                                            <textarea class="form-control"
                                                                id="cancellation_reason_reservation_<?php echo $order['order_id'] ?>"
                                                                required="required"></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="modal-footer">
