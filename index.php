				...
				<div class="col-md-4">
					<div class="our_qualities_column">
	                    ...
	                    <div class="caption">
	                        ...
	                        <p>
							Where Freshness Meets Excellence! Discover a world of flavor with our premium selection of fresh produce, meats, and gourmet delights
	                        </p>
	                    </div>
	                </div>
				</div>
				<div class="col-md-4">
					<div class="our_qualities_column">
	                    ...
	                    <div class="caption">
	                        ...
	                        <p>
							Get ready for lightning-fast delivery with our express service! We pride ourselves on delivering your favorite meals straight to your door in record time.
	                        </p>
	                    </div>
	                </div>
				</div>
				<div class="col-md-4">
					<div class="our_qualities_column">
	                    ...
	                    <div class="caption">
	                        ...
	                        <p>
							Dive into a world of culinary excellence with our premium selection of fresh produce, meats, and gourmet delights.
	                        </p>
	                    </div>
	                </div>
				</div>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="footer_widget">
                        <img src="Design/images/logos.png" alt="Restaurant Logo" style="width: 150px;margin-bottom: 20px;">
                        <p>
