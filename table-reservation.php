    ...
    <div class="container">
        ...
        if (isset($_POST['submit_table_reservation_form']) && $_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            try {
                ...
                if ($client_id) {
                    // Lakukan sesuatu jika $client_id tidak null
                    $stmt_reservation->execute(array(Date("Y-m-d H:i"), $client_id, $desired_date, $number_of_guests, $table_id));
                } else {
                    // Lakukan sesuatu jika $client_id adalah null
                    echo "<div class='alert alert-danger'>Error: Failed to get valid Client ID.</div>";
                }
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
                    <div class="form-group">
                        ...
                        <select class="form-control" name="number_of_guests">
                            ...
                            <option value="2" <?php echo (isset($_POST['number_of_guests'])) ? "selected" : ""; ?>>Two
                                people</option>
                            <option value="3" <?php echo (isset($_POST['number_of_guests'])) ? "selected" : ""; ?>>Three
                                people</option>
                            <option value="4" <?php echo (isset($_POST['number_of_guests'])) ? "selected" : ""; ?>>Four
                                people</option>
                        </select>
                    </div>
                </div>
        ...
        if (isset($_POST['check_availability_submit'])) {
            ...
            if ($stmt->rowCount() == 0) {
                ...
                <form method="POST" action="table-reservation.php">
                    ...
                    <div class="form-group">
                        <input type="submit" name="submit_table_reservation_form" class="btn btn-info"
